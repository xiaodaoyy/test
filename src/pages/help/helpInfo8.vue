<template>
  <div class="main">
    <div class="head"><span>医保消费查询</span></div>
    <div class="content">
      <h4 style="padding:10px 0px">功能说明</h4>
      <div style="text-indent:25px;font-size:14px">
      <span>查询个人医保消费信息。</span>
      </div>
      <h4 style="padding:10px 0px">操作说明</h4>
      <div style="text-indent:25px;font-size:14px">
        <p>1、点击“首页-信息查询-医保消费查询”。</p>
        <p>2、点击“账号信息”，查询账户情况。</p>
        <p>3、点击“就诊记录”，查询最近就诊记录。</p>
      </div>
    </div>
...
<style scoped>
  ...
  .foot>i>img{width: 100%;height: 100%;}
</style>
