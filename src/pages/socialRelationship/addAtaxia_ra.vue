<template>
  <div class="main">
    <headUser></headUser>
    <div class="head_tip">授权（下方人员使用“{{tmhandleName}}”医保历年账户中的余额）</div>
...
-->
      ...
      <div class="tip">设置完成后，<span>该成员可以使用{{tmhandleName}}医保历年账户中的余额</span></div>
        ...
        this.$http.get("/faceOne/url",{params:data})
          .then(res=>{
            if(res.success){
              ...
              localStorage.setItem('freemPhone', "00000000000");
