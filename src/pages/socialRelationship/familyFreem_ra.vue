      ...
      <mt-tab-container-item id="1">
        ...
        <div class="content">
          <div class="module" v-for="(item,index) in granteeList">
            ...
            <div class="user_oper" @click="op2(index)">解除授权</div>
          </div>
        </div>
        <div><router-link to="familyProtocol_ra"><input class="btn_sure" type="button" value="+  添加授权"/></router-link></div>
