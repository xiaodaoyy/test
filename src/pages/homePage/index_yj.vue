<template>
  <div class="main" v-title="'永嘉人社办事大厅'">
    <div class="head">
    ...
    <div class="content">
      <div class="div_module">
        <div class="module_title"><i><img src="../../assets/images/icon/icon-zhengmingbeian.png"/></i><span>证明备案</span></div>
        <ul>
  ...
  export default {
    ...
    methods: {
      ...
      isCertification:function() {
        ...
        let thisObj = this;
        this.$http.post("/gateway.do/1019?time="+new Date(),"\"" + Base64.encode(JSON.stringify(data))+ "\"")
          .then(function (res) {
            res = eval("("+Base64.decode(res)+")");
            if (res.body.need == "1") {
