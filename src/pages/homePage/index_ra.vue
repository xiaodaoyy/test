<template>
  <div class="main"  v-title="'瑞安人社办事大厅'">
      ...
      <div>
        ...
        <div class="div_module" id="tab3">
          ...
          <ul>
            ...
            <li>
              <router-link to="medInsurance_ra" v-show="showFlag">
                <i class="icon"><img src="../../assets/images/icon/icon-yibaoxiaofeichaxun.png"/></i>
                <div>医保消费查询测试</div>
              </router-link>
            </li>
            <li>
              <router-link to="persInterest_ra" v-show="showFlag">
                <i class="icon"><img src="../../assets/images/icon/icon-xinxibiangeng.png"/></i>
                <div class="name">个人权益单查询测试</div>
              </router-link>
            </li>
            <!--<li>
              <router-link to="helpMenu">
    ...
    <div style="height:470px;width:100%"></div>
